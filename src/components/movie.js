...
//Moive.js content
  ...
  <Col xs="12" lg="6" xl="4">
    ...
    <CardBody>
      <CardText>
      <p>LIKE <FontAwesomeIcon onClick={()=>{handleClick(props.movieName, props.movieImg)}} style={colorLike} icon={faHeart} /> <Badge color="secondary" ></Badge></p>
