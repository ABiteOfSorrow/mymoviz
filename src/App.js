...
function App() {
  ...
  var movieData = [{
    name: "StarWars : L'ascension de SkyWalker",
    img: "./img/starwars.jpg",
    desc: "La conclusion de la saga SkyWalker. De nouvells légendes vont naître dans cette....",
    note: 6,
    vote: 8
  },
  {
    ...
    desc: "Plusieur années après avoir découvert pourquoi la plus célèbre méchante Disney avait un coeur....",
    note: 9,
    vote: 4
  },
  {
  ...
  },
  {
    ...
    desc: "En 1969, Rick Dalton-star déclinante d'une série télévisée de zestern-et Cliff Booth....",
    note: 3,
    vote: 8
  },
  {
  ...
  {
    name: "Badboys 3 : Return to Bad Guys",
    img: "./img/badboy3.jpg",
    desc: "Les polices sont retourner...",
    note: 8,
    vote: 5
  }
]
